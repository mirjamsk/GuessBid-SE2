...
-- -----------------------------------------------------
-- procedure get_distinct_auction_rankings
-- -----------------------------------------------------

USE `guessbid_db`;
DROP procedure IF EXISTS `guessbid_db`.`get_distinct_auction_rankings`;
...
-- -----------------------------------------------------
-- procedure get_distinct_user_auction_ranking
-- -----------------------------------------------------

USE `guessbid_db`;
DROP procedure IF EXISTS `guessbid_db`.`get_distinct_user_auction_ranking`;

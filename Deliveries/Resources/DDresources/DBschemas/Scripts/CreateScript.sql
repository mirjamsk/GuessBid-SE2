...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `guessbid_db`.`active_auctions` (`auction_id` INT, `seller_id` INT, `name` INT, `description` INT, `end_time` INT, `winning_bid_id` INT, `timestamp` INT);

-- -----------------------------------------------------
-- Placeholder table for view `guessbid_db`.`finished_auctions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `guessbid_db`.`finished_auctions` (`auction_id` INT, `seller_id` INT, `name` INT, `description` INT, `end_time` INT, `winning_bid_id` INT, `timestamp` INT);
